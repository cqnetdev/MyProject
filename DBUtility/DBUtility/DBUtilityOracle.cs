...
{
    /// <summary>
    /// Oracle数据访问类，可用于访问不同数据库
    /// Copyright (C) 2017-09-18 By Chenqing
    /// 需要引入DLL的名称为：Oracle.ManagedDataAccess.dll，版本是：4.121.1.0
    /// 禁止私自增加返回DataReader的方法！！！
    /// </summary>
    public class DBUtilityOracle
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.    
        private string connectionString;
        public static string OracleConnectionStringDB1 = ConfigurationManager.ConnectionStrings["ConnectionString1"].ToString();
        public static string OracleConnectionStringDB2 = ConfigurationManager.ConnectionStrings["ConnectionString2"].ToString();
        public DBUtilityOracle()
        {
            connectionString = OracleConnectionStringDB1;
        }

        public DBUtilityOracle(string DBConnectionString)
        {
